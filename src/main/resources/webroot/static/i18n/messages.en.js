...
(function() {
    var messages_en_us = {
        ...
        connect_clean_session: 'Clean Session',
        connect_protocol_version: 'Protocol Version',
        connect_keep_alive: 'Keep Alive(Sec.)',
        connect_connect_time: 'Connect Time',

        session_clean_session: 'Clean Session',
