...
public class ClsUtil {
    ...
    private static final CacheAtomicityMode snapshot = CacheAtomicityMode.TRANSACTIONAL_SNAPSHOT;

    public static IgniteConfiguration igniteCfg() {
        // get cluster mode
        String clusterMode = Config.getClusterMode();
        // get ignite configuration
        IgniteConfiguration cfg = CacheUtil.igniteCfg(true, false, evnets());
    ...
    public static CacheConfiguration<String, MqttListener> listenerCfg() {
        return memCacheCfg(CacheConst.LISTENER_NAME, local, atomic, CacheConst.DEF_CACHE_BACKUPS, String.class, MqttListener.class);
    }

    public static CacheConfiguration<String, MqttConnection> connectionCfg() {
        return memCacheCfg(CacheConst.CONNECTION_NAME, local, trans, CacheConst.DEF_CACHE_BACKUPS, String.class, MqttConnection.class);
    }
